...
class Settings:
    ...
    def __init__(self, video_path="", verbose=True, export_path=None, texture_path=None,
        ...
        self.angle_step = 360/720  # 360/720
...
folder = '/Users/kawinklunchitt/Desktop/Senior Year/EE Project/Code/LineScanner'
settings = Settings(video_path=folder+"/images/laser1a_720.mp4", export_path=folder+"/3D/export/IMG_3123",
                    texture_path=folder+"/images/laser1_RGB_vertikal.jpg",
